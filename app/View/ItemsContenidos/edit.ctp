...
<?php echo $this->Form->create('ItemsContenido'); ?>
	<fieldset>
		<legend><?php echo __('Edit Items Contenido'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ItemsContenido.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ItemsContenido.id'))); ?></li>
