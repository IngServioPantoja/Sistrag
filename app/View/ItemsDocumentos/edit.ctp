...
<?php echo $this->Form->create('ItemsDocumento'); ?>
	<fieldset>
		<legend><?php echo __('Edit Items Documento'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ItemsDocumento.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ItemsDocumento.id'))); ?></li>
