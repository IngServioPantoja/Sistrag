<div class="itemsDocumentos index">
	<h2><?php echo __('Items Documentos'); ?></h2>
	...
	<?php foreach ($itemsDocumentos as $itemsDocumento): ?>
	<tr>
		<td><?php echo h($itemsDocumento['ItemsDocumento']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $itemsDocumento['ItemsDocumento']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $itemsDocumento['ItemsDocumento']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $itemsDocumento['ItemsDocumento']['id']), null, __('Are you sure you want to delete # %s?', $itemsDocumento['ItemsDocumento']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
