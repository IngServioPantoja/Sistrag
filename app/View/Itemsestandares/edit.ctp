...
<?php echo $this->Form->create('ItemsEstandar'); ?>
	<fieldset>
		<legend><?php echo __('Edit Items Estandar'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ItemsEstandar.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ItemsEstandar.id'))); ?></li>
