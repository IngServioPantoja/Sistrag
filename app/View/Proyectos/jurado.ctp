						...
						<span>
							...
							if(isset($busqueda))
							{
								...
								'atributo', array('id' => 'Id', 'nombre'=>'Nombre'
									),array('required'=>'required','id'=>'atributo','autocomplete' =>'off','empty'=>false,'default'=>$busqueda[0]['atributo'])
							);	
							}
							else
							{
							...
							echo $this->Form->select(
								'atributo', array('id' => 'Id', 'nombre'=>'Nombre'
									),array('required'=>'required','id'=>'atributo','autocomplete' =>'off','empty'=>false)
							);
							}
							?>
						</span>
