...
<?php echo $this->Form->create('Detalleentrega'); ?>
	<fieldset>
		<legend><?php echo __('Edit Detalleentrega'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Detalleentrega.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Detalleentrega.id'))); ?></li>
