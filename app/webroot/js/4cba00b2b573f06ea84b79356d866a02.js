...
return false;});
$("#programa_id").bind("change", function (event) {$.ajax({async:true, data:$("#programa_id").closest("form").serialize(), dataType:"html", success:function (data, textStatus) {$("#div_area").html(data);}, type:"post", url:"\/Sistrag\/areas\/lista_areas"});
return false;});
